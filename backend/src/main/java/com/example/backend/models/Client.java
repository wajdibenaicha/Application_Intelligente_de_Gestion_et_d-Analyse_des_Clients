...
public class Client {
    ...
    public Integer getAnneeInscription() { return anneeInscription; }
    public void setAnneeInscription(Integer anneeInscription) { this.anneeInscription = anneeInscription; }
    public Double getPrimeAnnuelle() { return primeAnnuelle; }
    public void setPrimeAnnuelle(Double primeAnnuelle) { this.primeAnnuelle = primeAnnuelle; }
